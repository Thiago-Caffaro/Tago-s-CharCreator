...
interface Props {
  ...
  /** When true, renders as a 360px sidebar (desktop mode) — parent must NOT wrap it in a fixed overlay */
  desktop?: boolean
}

export function EntryForm({ entry, onClose, onSave, desktop }: Props) {
